...
public val Iconography.IconHome: ImageVector
    get() {
        if (_iconHome != null) {
            return _iconHome!!
        }
        _iconHome = Builder(name = "IconHome", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF8B95A1)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(12.4453f, 1.3462f, 12.226f, 1.2695f, 12.0f, 1.2695f)
                curveTo(11.774f, 1.2695f, 11.5547f, 1.3462f, 11.378f, 1.487f)
                lineTo(2.93f, 8.204f)
                curveTo(2.6946f, 8.3913f, 2.5044f, 8.6293f, 2.3737f, 8.9002f)
                ...
                curveTo(21.4946f, 8.6303f, 21.3045f, 8.3923f, 21.069f, 8.205f)
            }
        }
        .build()
        return _iconHome!!
